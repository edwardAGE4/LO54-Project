    ...
    <div class="container-fluid">
        ...
        <div class="row">
                <div class="col-md-offset-2 col-md-8 col-xs-12">
                    ...
                    <form:form  class="form-horizontal form-material" action="${addAction}" commandName="course">
                        <c:if test="${!empty course.code}">
                             <div class="form-group">
                                <label class="col-md-12">Code UV</label>
                                <div class="col-md-12">
                                    <form:input path="code" placeholder="Veuillez saisir un code" class="form-control form-control-line"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-12">Libellé</label>
                                <div class="col-md-12">
                        ...
                        <c:if test="${empty course.code}">
                            ...
                            <div class="form-group">
                                <label class="col-md-12">Libellé</label>
                                <div class="col-md-12">
                                    <form:input path="title" placeholder="Veuillez saisir un titre" class="form-control form-control-line"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-12">
